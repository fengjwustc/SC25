#!/bin/bash
#PJM -L  "node=20480"                          # Number of assign node 8 (1 dimention format)
...
mpiexec -stdout-proc ./output.%j/%/1000r/stdout -stderr-proc ./output.%j/%/1000r/stderr /home/u12219/scratch/zhangxiangyu/Forfugaku/examples/dghf 