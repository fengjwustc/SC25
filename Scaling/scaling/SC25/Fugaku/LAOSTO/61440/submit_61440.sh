#!/bin/bash
#PJM -L  "node=61440"                          # Number of assign node 8 (1 dimention format)
#PJM -L  "freq=2200,eco_state=2"                         
#PJM -L  "rscgrp=huge"         # Specify resource group
#PJM -L  "elapse=00:45:00"                 # Elapsed time limit 1 hour
